 ...
 */
package com.ytest.cockpits.setup;
...
import com.ytest.cockpits.constants.YTestCockpitsConstants;
 ...
 */
@SystemSetup(extension = YTestCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(YTestCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(YTestCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						YTestCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/yTestcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
