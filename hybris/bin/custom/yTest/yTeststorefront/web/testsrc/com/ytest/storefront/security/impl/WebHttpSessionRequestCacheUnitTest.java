...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/yTeststorefront/electronics/en",
						"https://electronics.local:9002/yTeststorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/yTeststorefront/electronics/en",
						"https://electronics.local:9002/yTeststorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/yTeststorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/yTeststorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/yTeststorefront/electronics/en",
						"https://electronics.local:9002/yTeststorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/yTeststorefront",
						"https://electronics.local:9002/yTeststorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/yTeststorefront",
						"https://electronics.local:9002/yTeststorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/yTeststorefront/electronics/en",
						"https://electronics.local:9002/yTeststorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
