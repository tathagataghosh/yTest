...
import com.ytest.test.constants.YTestTestConstants;
import com.ytest.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = YTestTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/yTesttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/yTesttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/yTesttest/import/cstickets.impex");
			...
			importImpexFile(context, "/yTesttest/import/csquotes.impex");
		}
	}
}
