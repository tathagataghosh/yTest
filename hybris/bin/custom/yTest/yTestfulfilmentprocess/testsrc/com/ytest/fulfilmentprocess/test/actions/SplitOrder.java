 ...
 */
package com.ytest.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(YTestFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(YTestFulfilmentProcessConstants.PARENT_PROCESS);
