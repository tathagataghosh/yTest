 ...
 */
package com.ytest.core.constants;

/**
 * Global class for all YTestCore constants. You can add global constants for your extension into this class.
 */
public final class YTestCoreConstants extends GeneratedYTestCoreConstants
{
	public static final String EXTENSIONNAME = "yTestcore";


	private YTestCoreConstants()
	{
		//empty
	}
