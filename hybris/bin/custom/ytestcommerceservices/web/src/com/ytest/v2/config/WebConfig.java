 ...
 */
package com.ytest.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.ytest.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "ytestcommerceservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "ytestcommerceservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "ytestcommerceservices.oauth2.tokenUrl";

	private static final String DESC = "ytestcommerceservices.v2.description";
	private static final String TITLE = "ytestcommerceservices.v2.title";
	private static final String VERSION = "ytestcommerceservices.v2.version";
