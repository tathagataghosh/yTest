...
public class SaveCartController extends BaseCommerceController
{
	...
	@ResponseBody
	@ApiOperation(value = "Flag a cart for deletion.", notes = "Flags a cart for deletion (the cart doesn't have corresponding save cart attributes anymore). The cart is not actually deleted from the database. "
	...
	@ResponseBody
	@ApiOperation(value = "Get a saved cart.", notes = "Returns saved cart by it id for authenticated user.")
	@ApiBaseSiteIdAndUserIdParam
