 ...
 */
package com.yTest.yTestcommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.yTest.yTestcommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "yTestcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "yTestcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "yTestcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "yTestcommercewebservices.v2.description";
	private static final String TITLE = "yTestcommercewebservices.v2.title";
	private static final String VERSION = "yTestcommercewebservices.v2.version";
